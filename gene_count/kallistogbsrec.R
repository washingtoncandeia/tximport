...
plotMA(resIHW, xlim=xlim, ylim=ylim, main="Guillain-Barré Recuperados vs Controles \n(IHW)")
plotMA(res025, xlim=xlim, ylim=ylim, main="Guillain-Barré Recuperados vs Controles \n(padj < 0.01)")
...
par(mfrow=c(2,2), mar=c(4,4,4,2))
xlim <- c(1,1e5); ylim <- c(-3,3)
plotMA(res, xlim=xlim, ylim=ylim, main="Guillain-Barré Recuperados vs Control \n(pdaj < 0.1)")
...
plotMA(res05, xlim=xlim, ylim=ylim, main="Guillain-Barré Recuperados vs Control \n(padj < 0.01)")
plotMA(resIHW, xlim=xlim, ylim=ylim, main="Guillain-Barré Recuperados vs Control \n(IHW)")
